...
public class SqlSelects3 {
	/*public static Connection ConnectionConfiguration.conectarConsulta(){
		 Connection con = null;
	        Statement st = null;
	        ResultSet rs = null;
	        ...
	        try {con = DriverManager.getConnection("jdbc:mysql://mysql01.stp.gov.py/spr", "postgres", "postgres");}
	...
	public static List<Usuario> selectUsuario(String condition) throws SQLException{
 	 Connection conect=ConnectionConfiguration.conectarSprConsulta();
	...
	public static List<FactHitos> selectFactHitos2015(String condition) throws SQLException{
    	 Connection conect=ConnectionConfiguration.conectarConsulta();
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from departamento";
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from mes";
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from eje_estrategico";
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from entidad "+condition;
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from fuente_financiamiento";
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from funcional where es_imputable ='S'";
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from nivel "+condition;
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from objeto_de_gasto";
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from organismo_financiador";
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from estrategia where plan=9";
//		 Statement statement = null; ResultSet rs=null;
...
//   	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from plan";
//		 Statement statement = null; ResultSet rs=null;
...
// 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from catalogo_dncp";
//	 Statement statement = null; ResultSet rs=null;
...
//     	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from tipo_presupuesto";
//    	 Statement statement = null; ResultSet rs=null;
...
//     	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from tipo_catalogo_destinatario";
//    	 Statement statement = null; ResultSet rs=null;
...
//     	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from catalogo_destinatario "+condition;
//    	 Statement statement = null; ResultSet rs=null;
...
//	 	Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from programa "+condition;
//		 Statement statement = null; ResultSet rs=null;
...
//			Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from subprograma "+condition;
//			 Statement statement = null; ResultSet rs=null;
...
//			Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from proyecto "+condition;
//		 	
//			 Statement statement = null; ResultSet rs=null;
...
//			Connection conect=ConnectionConfiguration.conectarConsulta();String query = " select * from producto_presupusto "+condition;
//		 	
//			 Statement statement = null; ResultSet rs=null;
