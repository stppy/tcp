...
$("body").on("click", "#actualizarEtiqueta",function(event){		
	var objeto = new Object();
	var accion = "actEtiqueta";
	var id = $("#idEtiqueta").val();
	var nombre= $("#nombreEtiqueta").val();	
	var descripcion= $("#descripcionEtiqueta").val();		
	var borrado= $("#borradoEtiqueta").val();
...
$("body").on("click", "#iconoBorradoEtiqueta",function(event){		
	var objeto = new Object();
	var accion = "borradoEtiqueta";
	var parametrosBorradoEtiqueta = $(this).attr("parametrosBorradoEtiqueta");
    var idParsed = parametrosBorradoEtiqueta.split("-");                                                            
	var id = idParsed[0];
	...
	$.ajax({
		...
		window.location.href = "http://tablero2015.stp.gov.py/tablero/contenedorEtiqueta.jsp";
});	
</script>