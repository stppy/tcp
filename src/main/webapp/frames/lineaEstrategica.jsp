<div class="modal fade" id="lineaEstrategica" tabindex="-1"  aria-labelledby="myModalLabel" aria-hidden="true">
		    ...
		    <div class="modal-body" id="lineaEstrategica" >
				<form class="form-horizontal" role="form">
				  <div class="form-group">
				    ...
				    <div class="col-lg-10">
				      <input type="hidden" class="form-control" id="idLineaEstrategica">
	...
	$("body").on("click", "#actualizarLineaEstrategica",function(event)
			{
				var objeto = new Object();
				var accion = "actLineaEstrategica";
				var id = $("#idLineaEstrategica").val();
				var nombre = $("#nombreLineaEstrategica").val();
				var descripcion= $("#descripcionLineaEstrategica").val();
				var orden= $("#ordenLineaEstrategica").val();
				objeto.id = id;
	...
	$("body").on("click", "#iconoBorradoLineaEstrategica",function(event)
			{
				var objeto = new Object();
				var accion = "borradoLineaEstrategica";
				var parametrosBorradoLineaEstrategica = $(this).attr("parametrosBorradoLineaEstrategica");
			    var idParsed = parametrosBorradoLineaEstrategica.split("-");                                                            
				var id = idParsed[0];
				...
				window.location.href = "http://tablero2015.stp.gov.py/tablero/contenedorLineaEstrategica.jsp";
			});	
	</script>	
