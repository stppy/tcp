...
if (user != null) { %>
	...
	$(document).ready(function(){
	    ...
	    $("#nivel2").attr("value",usuarios[0].nivel_id);
	    $("#nivel2").attr("disabled","");
	    $("#entidad2").attr("value",usuarios[0].entidad_id);
	    $("#entidad2").attr("disabled","");
	    $("#nivel").attr("value",usuarios[0].nivel_id);
	    
	    $("#entidad").attr("value",usuarios[0].entidad_id);
	    
	    $("#descripcion").html(datosEntidad[i].descripcion);
		$("#abrev").attr("value",datosEntidad[i].abrevEntidad);
		$("#sigla").attr("value",datosEntidad[i].siglaEntidad);
		$("#ruc").html(datosEntidad[i].ruc);
		$("#baseLegal").html(datosEntidad[i].baseLegal);
		$("#mision").html(datosEntidad[i].mision);
		$("#vision").html(datosEntidad[i].vision);
		$("#politica").html(datosEntidad[i].politica);
		$("#objetivo").html(datosEntidad[i].objetivo);
		$("#diagnostico").html(datosEntidad[i].diagnostico);
