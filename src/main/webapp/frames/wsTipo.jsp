...
$("body").on("click", "#iconoBorradoWsTipo",function(event){		
	var objeto = new Object();
	var accion = "borradoWsTipo";
	var parametrosBorradoWsTipo = $(this).attr("parametrosBorradoWsTipo");
    var idParsed = parametrosBorradoWsTipo.split("-");                                                            
	var id = idParsed[0];
	...
	window.location.href = "http://tablero2015.stp.gov.py/tablero/contenedorWsTipo.jsp";
});	
</script>