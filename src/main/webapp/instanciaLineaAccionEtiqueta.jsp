	...
	for(var w=0; w<insLineaAccion.length;w++)
	{
		if(insLineaAccion[w].borrado != true){
			...
			var instanciaEtiqueta = $.ajax({
				url:'http://spr.stp.gov.py/tablero/ajaxSelects2?action=getInsLineaAccionHasEtiqueta&insLineaAccionId='+insLineaAccion[w].id,
				type:'get',
			  	dataType:'json',
			  	async:false       
			}).responseText;
				...
				for(var i = 0; i < etiquetas.length; i++){
					for(var l = 0; l < instanciaEtiqueta.length; l++){
						if(instanciaEtiqueta[l].etiqueta_id == etiquetas[i].id && instanciaEtiqueta[l].borrado != true){
							etiquetasUsuario += '<input type="checkbox" class="cmbEditarEtiquetaInstancia" id=e-'+insLineaAccion[w].id+'-'+instanciaEtiqueta[l].etiqueta_id+'-'+insLineaAccion[w].version+'-'+insLineaAccion[w].lineaAccionId+'-'+insLineaAccion[w].institucionId+'-'+insLineaAccion[w].periodoId+'-'+insLineaAccion[w].meta+' checked="true"><a> '+etiquetas[i].nombre+'</a> ';
							...
							etiquetasUsuario += '<input type="checkbox" class="cmbEditarEtiquetaInstancia" id=e-'+insLineaAccion[w].id+'-'+instanciaEtiqueta[l].etiqueta_id+'-'+insLineaAccion[w].version+'-'+insLineaAccion[w].lineaAccionId+'-'+insLineaAccion[w].institucionId+'-'+insLineaAccion[w].periodoId+'-'+insLineaAccion[w].meta+'><a> '+etiquetas[i].nombre+'</a> ';
							etiquetasSeleccionada.push(etiquetas[i].id);
						}
					}
				}
			...
			for(var h = 0; h < etiquetas.length; h++){
				if (etiquetasSeleccionada.indexOf(etiquetas[h].id)<0){
					etiquetasUsuario += '<input type="checkbox" class="cmbEditarEtiquetaInstancia" id=n-'+insLineaAccion[w].id+'-'+etiquetas[h].id+'-'+insLineaAccion[w].version+'-'+insLineaAccion[w].lineaAccionId+'-'+insLineaAccion[w].institucionId+'-'+insLineaAccion[w].periodoId+'-'+insLineaAccion[w].meta+'><a> '+etiquetas[h].nombre+'</a> ';
									...
									//{
										if(insLineaAccion[w].periodoId == PeriodoActual)
									 	{		 		
											...
											if(insLineaAccion[w].borrado == true){
												<% if (attributes.get("role_id_tablero").toString().equals("0") || attributes.get("role_id_tablero").toString().equals("1")){%>
							 						cuerpoTablaInsLineaAccion+='<td><del>'+numeroConComa(parseFloat(insLineaAccion[w].meta))+'</del></td><td class="text-center"><del>'+nombreUnidadMedida+'</del></td><td></td></tr>';	 						
							 						<%}%>	
												}else{
												<% if (attributes.get("role_id_tablero").toString().equals("0") || attributes.get("role_id_tablero").toString().equals("1")){%>
							 						cuerpoTablaInsLineaAccion+='<td>'+numeroConComa(parseFloat(insLineaAccion[w].meta))+'</td><td class="text-center">'+nombreUnidadMedida+'</td><td class="text-center">'+etiquetasUsuario+'</td></tr>';
												<%} if (attributes.get("role_id_tablero").toString().equals("3")){%>
													cuerpoTablaInsLineaAccion+='<td>'+numeroConComa(parseFloat(insLineaAccion[w].meta))+'</td><td class="text-center">'+nombreUnidadMedida+'</td><td class="text-center"></td></tr>';
												<%}%>
											}
										}
									 	...
									 	{		 		
											...
											if(insLineaAccion[w].borrado == true){
												<% if (attributes.get("role_id_tablero").toString().equals("0") || attributes.get("role_id_tablero").toString().equals("1")){%>
							 						cuerpoTablaInsLineaAccionPosterior+='<td><del>'+insLineaAccion[w].meta+'</del></td><td class="text-center"><del>'+nombreUnidadMedida+'</del></td><td></td></tr>'; 
												<%}%>
											}else{
												<% if (attributes.get("role_id_tablero").toString().equals("0") || attributes.get("role_id_tablero").toString().equals("1")){%>
							 						cuerpoTablaInsLineaAccionPosterior+='<td>'+insLineaAccion[w].meta+'</td><td class="text-center">'+nombreUnidadMedida+'</td><td class="text-center">'+etiquetasUsuario+'</td></tr>';
												<%} if (attributes.get("role_id_tablero").toString().equals("3")){%>
													cuerpoTablaInsLineaAccionPosterior+='<td>'+insLineaAccion[w].meta+'</td><td class="text-center">'+nombreUnidadMedida+'</td><td class="text-center"></td></tr>';
												<%}%>
											}
										}
									 	...
									 	{		 		
											...
											if(insLineaAccion[w].borrado == true){
												<% if (attributes.get("role_id_tablero").toString().equals("0") || attributes.get("role_id_tablero").toString().equals("1")){%>
							 						cuerpoTablaInsLineaAccionAnterior+='<td><del>'+insLineaAccion[w].meta+'</del></td><td class="text-center"><del>'+nombreUnidadMedida+'</del></td><td class="text-center"></td></tr>';
												<%}%>
											}else{
												<% if (attributes.get("role_id_tablero").toString().equals("0") || attributes.get("role_id_tablero").toString().equals("1")){%>
							 						cuerpoTablaInsLineaAccionAnterior+='<td>'+insLineaAccion[w].meta+'</td><td class="text-center">'+nombreUnidadMedida+'</td><td class="text-center">'+etiquetasUsuario+'</td></tr>';
												<%} if (attributes.get("role_id_tablero").toString().equals("3")){%>
													cuerpoTablaInsLineaAccionAnterior+='<td>'+insLineaAccion[w].meta+'</td><td class="text-center">'+nombreUnidadMedida+'</td><td class="text-center"></td></tr>';
												<%}%>
											}
										}	
									//}
	...
	var tablaInsLineaAccion = 	'<div class="table-responsive">'+
			'<table class="table table-hover" id="dataTableInsLineaAccion">'+
				'<thead>'+
			  		...
			  		'<tr class="active"><th style="min-width:110px">Periodo</th><th>Institución</th><th>Línea de Acción</th><th>Meta</th><th class="text-center">U.Medida</th><th style="min-width:250px" class="text-center">Administrar Etiquetas </th></tr>'+
			 	'</thead>'+
