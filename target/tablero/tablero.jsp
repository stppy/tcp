...
*/
	...
	$(document).ready(function(){
		...
		for (var i = 0; i< entidades.length;i++){
			$("#cuerpoTabla").append('<tr><td colspan="10" ><strong>'+entidades[i].institucion+'</strong></td></tr>');
				...
				if (el[j].institucion_id==entidades[i].institucion_id){
					if (lineasDeAccion.indexOf(el[j].linea_accion_id)<0){
						...
						if(el[j].anho<="2014"){
							...
							$("#cuerpoTabla").append('<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+anho1.linea_accion+'</td><td>'+anho1.accion_unidad_medida+'</td><td>'+anho1.cantidad_ejecutada_hoy+'</td><td></td><td>'+anho2.suma_programada_anho+'</td><td class="'+sumporAClass+'">'+porcentajeAnho+'</td><td>'+anho2.suma_programada_hoy+'</td><td>'+anho2.cantidad_ejecutada_hoy+'</td><td class="'+porAejeClass+'">'+porcentajeAnhoEje+'</td><td class="'+porHejeClass+'">'+porcentajeHoyEje+'</td></tr>');
							anho2="";
							anho1="";
						}
						if(el[j].anho>="2015"){
							...
							$("#cuerpoTabla").append('<tr><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'+anho2.linea_accion+'</td><td>'+anho2.accion_unidad_medida+'</td><td>'+anho1.cantidad_ejecutada_hoy+'</td><td></td><td >'+anho2.suma_programada_anho+'</td><td class="'+sumporAClass+'">'+porcentajeAnho+'</td><td>'+anho2.suma_programada_hoy+'</td><td>'+anho2.cantidad_ejecutada_hoy+'</td><td class="'+porAejeClass+'">'+porcentajeAnhoEje+'</td><td class="'+porHejeClass+'">'+porcentajeHoyEje+'</td></tr>');
							anho2="";
							anho1="";
						}
					}
	         ...
	         <div class="col-md-12">
              ...
              <thead>
                <tr style="background-color: white;">
                  ...
                  <th></th>
                  <th></th>
                  <th colspan="3" class="text-center">Programacion</th>
                  <th colspan="3" class="text-center">Ejecucion</th>
                </tr>
                <tr style="background-color: white;">
