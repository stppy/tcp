<script>
	...
	$("body").on("click", ".nuevaInsLineaAccion",function(event){		
		...
		contenido =			'<div class="modal fade" id="insLineaAccion" tabindex="-1"  aria-labelledby="myModalLabel" aria-hidden="true">'+
							...
							'		        <h4 class="modal-title">Registrar L�nea de Acción por Instituci�n</h4>'+
							'			</div>'+
							...
							'						<input type="number" id="versionInsLineaAccion" class="form-control" name="version" placeholder="Ingrese Versi�n">'+
							'					</div>'+				
							'				</form>'+			  
		        	...
		        	{						
						...
						tablaInsLineaAccion += 	'<div class="table-responsive">'+
												'<table class="table table-hover">'+
												  '<tr class="active"><td colspan="6">L�nea de Acción por Instituci�n</td></tr>'+
												  '<tr class="active"><td style="min-width:110px">Periodo</td><td>Instituci�n</td><td>L�nea de Acción</td><td>Meta</td><td class="text-center">U.Medida</td><td style="min-width:250px" class="text-center">Administrar Linea Acción</td></tr>';
...
$("body").on("click", ".actualizarAccion",function(event){
    ...
    //aca vac�o el formulario de edici�n de Acción
...
$("body").on("click", ".borrarAccion",function(event){	
							    ...
							    '<div class="modal-dialog modal-lg" style="width:90%">'+ 
							      ...
							      '<div class="modal-content">'+ 
							        '<div class="modal-header">'+ 
							          ...
							          '<h4 class="modal-title">Vincular Producto con '+catalogoAccion[0].nombre+' de '+lineaAccion[0].nombre+' ('+institucion[0].sigla+') a�o '+insLineaAccion[0].periodoId+'</h4>'+ 
							        '</div>'+ 
							        '<div class="modal-body">'+ 				        
	...
	$("body").on("click", ".agregarActividad",function(event){
		...
		'	                				<table class="table table-hover table-bordered">'+
		'	                					<thead>'+
		'	                						<tr class="active"><th class="text-center">Nombre</th><th class="text-center">Descripci�n</th><th class="text-center">Unidad Medida</th><th class="text-center">Tipo Cronograma</th><th class="text-center">Proporci�n</th><th class="text-center">Versi�n</th><th class="text-center">Administrar Cronograma</th></tr>'+
		'	                					</thead>'+
...
$("body").on("click", ".editarCronograma", function(event){
	...
	cuerpoModalEditarCronograma =	'<div class="modal fade" id="modalEditarCronograma" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="myLargeModalLabel">'+
						...
						'												<tr><td><label for="proporcionCronograma">Proporci�n</label><input type="text" id="proporcionCronograma" value='+actividades[0].proporcion+' class="form-control" /></td><td><label for="versionCronograma">Versi�n</label><input type="text" id="versionCronograma" class="form-control" value='+actividades[0].version+'  /></td></tr>'+
						'			      							</form>	'+												
						'										</tbody>'+
						'									</table>'+
						'				      			</div>'+
...
$("body").on("click", ".actualizarCronograma", function(event){
    ...
    //aca vac�o el formulario de edici�n de cronograma
...
$("body").on("click", ".agregarProgramacion",function(event){
	...
	modalProgramacion += '<div class="modal fade" id="modalProgramacion" tabindex="-1" aria-labelledby="myLargeModalLabel">'+
							...
							'								<div class="table-responsive">'+
							'									<table class="table table-hover table-bordered">'+
							'										<thead><tr class="active"><th>Cantidad</th><th>FechaEntrega</th><th>Versi�n</th><th>Cronograma</th></tr>'+
...
$("body").on("click", ".agregarAvance",function(event){
	...
	modalAvance += '<div class="modal fade" id="modalAvance" tabindex="-1" aria-labelledby="myLargeModalLabel">'+
							...
							'										<tbody>'+
							'			      							<form class="form-horizontal" role="form">'+
							'											<tr><td><label for="justificacionAvance">Justificaci�n</label><input type="text" id="justificacionAvance" value="" class="form-control" placeholder="Ingrese Justificaci�n" /></td><td><label for="cantidadAvance">Cantidad</label><input type="number" id="cantidadAvance" class="form-control" value="" placeholder="Ingrese Cantidad" /></td></tr>'+
							...
							'								<div class="table-responsive">'+
							'									<table class="table table-hover table-bordered">'+
							'										<thead><tr class="active"><th>Justificaci�n</th><th>cantidad</th><th>Fecha Entrega</th><th>Cantidad Beneficiarios</th><th>Administrar</th></tr>'+
...
$("body").on("click", ".agregarModalAdministrador",function(event){
	...
	contenidoModalAdministrador +=  '<div class="modal fade" id="modalAdministrador" tabindex="-1" aria-labelledby="myLargeModalLabel">'+
									...
									'									<table class="table table-hover table-bordered">'+
									'										<thead>'+
									'											<tr class="active"><th>Justificaci�n</th><th>Cantidad</th><th>FechaEntrega</th><th>CantidadBeneficiarios</th><th class="text-center">Administrar</th></tr>'+
									' 										</thead>'+
									'										<tbody>'+
									...
									'											<table class="table table-hover table-bordered">'+
									'												<thead>'+
									'													<tr class="active"><th>Nombre</th><th>Descripci�n</th><th>Url</th><th>WsId</th><th>Versi�n</th><th>AvanceId</th><th class="text-center">Administrar</th></tr>'+
									'												</thead>'+
									'												<tbody>'+
