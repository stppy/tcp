...
$("body").on("click", "#iconoBorradoBeneficiarioTipo",function(event){		
	var objeto = new Object();
	var accion = "borradoBeneficiarioTipo";
	var parametrosBorradoBeneficiarioTipo = $(this).attr("parametrosBorradoBeneficiarioTipo");
    var idParsed = parametrosBorradoBeneficiarioTipo.split("-");                                                            
	var id = idParsed[0];
	...
	$.ajax({
		...
		window.location.href = "http://tablero2015.stp.gov.py/tablero/contenedorBeneficiarioTipo.jsp";
});	
</script>
