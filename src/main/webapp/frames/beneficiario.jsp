...
$("body").on("click", "#iconoBorradoBeneficiario",function(event){
	var objeto = new Object();
	var accion = "borradoBeneficiario";
	var parametrosBorradoBeneficiario = $(this).attr("parametrosBorradoBeneficiario");
    var idParsed = parametrosBorradoBeneficiario.split("-");                                                            
	var id = idParsed[0];
	...
	window.location.href = "http://tablero2015.stp.gov.py/tablero/contenedorBeneficiario.jsp";
});	
</script>