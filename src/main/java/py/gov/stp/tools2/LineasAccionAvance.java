...
public class LineasAccionAvance {
	...
	public String getCronoNombre() {
		return cronoNombre;
	}
	public void setCronoNombre(String cronoNombre) {
		this.cronoNombre = cronoNombre;
	}
	...
	public String getCronoProporcion() {
		return cronoProporcion;
	}
	public void setCronoProporcion(String cronoProporcion) {
		this.cronoProporcion = cronoProporcion;
	}
	public int getCronoPeso() {
		return cronoPeso;
	}
	public void setCronoPeso(int cronoPeso) {
		this.cronoPeso = cronoPeso;
	}
	public int getCronoVersion() {
		return cronoVersion;
	}
	...
	public int getAvanceCantidad() {
		return avanceCantidad;
	}
	public void setAvanceCantidad(int avanceCantidad) {
		this.avanceCantidad = avanceCantidad;
	}
	public String getAvanceFechaEntrega() {
		return avanceFechaEntrega;
	}
	public void setAvanceFechaEntrega(String avanceFechaEntrega) {
		this.avanceFechaEntrega = avanceFechaEntrega;
	}
	public int getAvanceCantidadBeneficiarios() {
		return avanceCantidadBeneficiarios;
	}
	public void setAvanceCantidadBeneficiarios(int avanceCantidadBeneficiarios) {
		this.avanceCantidadBeneficiarios = avanceCantidadBeneficiarios;
	}
	public int getAvanceVersion() {
		return avanceVersion;
	}
	...
	public String getAvanceCostoGasto() {
		return avanceCostoGasto;
	}
	public void setAvanceCostoGasto(String avanceCostoGasto) {
		this.avanceCostoGasto = avanceCostoGasto;
	}
	public int getAvanceCostoVersion() {
		return avanceCostoVersion;
	}
