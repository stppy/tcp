<div class="modal fade" id="accionHasEtiqueta" tabindex="-1"  aria-labelledby="myModalLabel" aria-hidden="true">
	...
	$("body").on("click", "#iconoBorradoAccionHasEtiqueta",function(event)
			{
				var objeto = new Object();
				var accion = "borradoAccionHasEtiqueta";
				var parametrosBorradoAccionHasEtiqueta = $(this).attr("parametrosBorradoAccionHasEtiqueta");
			    var idParsed = parametrosBorradoAccionHasEtiqueta.split("-");                                                            
				var accionId = idParsed[0];
				var etiquetaId = idParsed[1] 
				...
				window.location.href = "http://tablero2015.stp.gov.py/tablero/contenedorAccionHasEtiqueta.jsp";
			});
